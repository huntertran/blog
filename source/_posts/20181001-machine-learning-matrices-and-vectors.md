...
% You could also store it this way dim\_A = size(A)

% Get the dimension of the vector v dim\_v = size(v)
...
mul\_AB = -34.750 -32.500 -33.750 -34.500 \[/code\]
...
Gọi $latex A$ và $latex B$ là 2 matrix, ta có:
...
Ký hiệu: $latex I$ hoặc $latex I\_{n \\times n}$
...
> 
> 3 là một số thực. Ta có: $latex 3 \\times (3^{-1}) = 1$
> 
> Tổng quát: $latex a \\times (a^{-1}) = 1$
