...
- [1. DbContext của Entity Framework Core](#1-dbcontext-c%E1%BB%A7a-entity-framework-core)
    - [1.1. DbContext Tracking](#11-dbcontext-tracking)
- [2. Repository](#2-repository)
    - [2.1. Lý do](#21-l%C3%BD-do)
    - [2.2. Implement](#22-implement)
    - [2.3. Performance Hit](#23-performance-hit)
- [3. Generic Repository](#3-generic-repository)
- [4. Tạo class Unit of Work](#4-t%E1%BA%A1o-class-unit-of-work)
- [5. Tổng kết](#5-t%E1%BB%95ng-k%E1%BA%BFt)

<!-- /TOC -->

# 1. DbContext của Entity Framework Core
<a id="markdown-dbcontext-c%E1%BB%A7a-entity-framework-core" name="dbcontext-c%E1%BB%A7a-entity-framework-core"></a>
...
> Bạn có thể tham khảo thêm về cách thiết lập `DbContext` ở [đây](https://huntertran.ca/2018/03/11/asp-net-for-beginner-part-2-connect-database-and-model-binding/), mục 3.2
...
![repository diagram](/images/flickr/1724/42213219384_ec3b0b1b3e_o.png)
...
## 2.1. Lý do
<a id="markdown-l%C3%BD-do" name="l%C3%BD-do"></a>
...
## 2.2. Implement
<a id="markdown-implement" name="implement"></a>
...
## 2.3. Performance Hit
<a id="markdown-performance-hit" name="performance-hit"></a>
...
<a id="markdown-generic-repository" name="generic-repository"></a>
...
<a id="markdown-t%E1%BA%A1o-class-unit-of-work" name="t%E1%BA%A1o-class-unit-of-work"></a>
...
# 5. Tổng kết
<a id="markdown-t%E1%BB%95ng-k%E1%BA%BFt" name="t%E1%BB%95ng-k%E1%BA%BFt"></a>
