...
> Bài viết này giả định rằng bạn sử dụng Entity Framework, như đã nói ở [phần 2](https://huntertran.ca/2018/03/11/asp-net-for-beginner-part-2-connect-database-and-model-binding/), và đã có sẵn code trong ví dụ Bạn có thể clone code tại Github ở [đây](https://github.com/huntertran/mvcbasic/releases/tag/0.2)
...
> Bạn có thể tìm hiểu sâu hơn về cách làm 1 câu error message chung cho tất cả các property cùng loại tại đây: [Error Message – chung mà riêng](https://huntertran.ca/2018/01/14/asp-net-mvc-error-message-chung-ma-rieng/)
